...
# Meurtrier : si tu tues un ennemis, le prochain Skill ne co�tera rien 
# Retenue : Tout les skills utilis� laisse l'ennemi a 1pv.
# Rapide comme l'�clair : chaque coup d'une attaque multi coup a 50% de chance de declencher un autre coup 
